            ...
            >
                ...
                return (
                  <div className="w-full md:w-[320px] shrink-0 bg-stone-50 p-6 flex flex-col justify-between border-b md:border-b-0 md:border-r border-stone-200">
                    <div className="space-y-4">
                      ...
                      {/* Interactive Packaging Selection */}
                          ...
                          {packagings.map((pkg, idx) => {
                            ...
                            return (
                              <button
                                key={idx}
                                onClick={() => setSelectedPackagingIndex(idx)}
                                className={`border rounded-lg p-1 transition-all cursor-pointer ${
                                  isActive
                                    ? "border-emerald-green bg-emerald-green/5 shadow-3xs"
                                    : "border-stone-200 bg-white hover:border-stone-300"
                                }`}
                              >
                                <div className="aspect-square w-full rounded-md overflow-hidden border border-stone-100">
                                  <img 
                                    src={pkg.image} 
                                    alt={pkg.name || "packaging"} 
                                    className="w-full h-full object-cover"
              ...
              <div className="flex-1 p-6 sm:p-8 flex flex-col justify-between space-y-6">
                <div className="space-y-4">
                  ...
                  {/* Pricing row */}
                  <div className="flex items-baseline gap-3">
                    <span className="text-xl font-bold text-red-500">{getProductPriceRange(selectedProductDetails, detailsQuantity)}</span>
